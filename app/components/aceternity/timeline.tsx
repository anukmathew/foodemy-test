...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
	...
	return (
		<div
			className="w-full font-sans md:px-10 dark:bg-neutral-950"
			ref={containerRef}
		>
			<div ref={ref} className="relative mx-auto max-w-7xl pb-20">
				...
				>
					<motion.div
						...
						className="from-info via-accent absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-[0%] via-[10%] to-transparent"
					/>
				</div>
			</div>
		</div>
