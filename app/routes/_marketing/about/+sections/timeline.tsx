...
export default function FoodemyTimeline() {
	const data = [
		...
		},
		{
			...
			content: (
				<div>
					<div className="flex h-48 w-full rounded-2xl bg-radial bg-[url(/resources/images?src=/img/timeline/yt.jpg&format=webp&w=1200&h=800&fit=cover)] bg-cover bg-center md:h-60 lg:h-96">
		...
		},
		{
			...
			content: (
				<div>
					<div className="flex h-48 w-full rounded-2xl bg-radial bg-[url(/resources/images?src=/img/timeline/grad.jpg&format=webp&w=1200&h=800&fit=cover)] bg-cover bg-center md:h-60 lg:h-96">
						<div className="flex w-full flex-1 items-center bg-radial-[at_50%_50%] from-black/50 from-50% to-transparent to-100% p-4">
							<span className="w-full text-center text-xl font-bold text-white md:text-2xl lg:text-3xl">
