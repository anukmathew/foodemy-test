...
export default function TeamMateCard({
	...
	return (
		<div className="border-muted group from-muted to-muted-foreground relative flex flex-col overflow-hidden rounded-2xl border bg-radial-[at_50%_40%] from-20% shadow-md transition duration-300">
			...
			<div className="z-20 flex flex-col justify-center bg-white p-2 text-center md:p-4 md:text-left">
				<h3 className="text-primary-foreground font-display text-sm font-semibold md:text-lg">
					{name}
				</h3>
